...
class PHPMailer
{
     ...
     * To generate iCal schedule structures, use classes like EasyPeasyICS or iCalcreator.
     *
...
//            $result .= static::$LE;
    ...
    public function encodeHeader($str, $position = 'text')
    {
        ...
        // Select the encoding that produces the shortest output and/or prschedules corruption.
        if ($matchcount > strlen($str) / 3) {
            ...
            // No encoding needed, but value exceeds max line length, use Q-encode to prschedule corruption.
            $encoding = 'Q';
        } else {
    ...
    /**
     * Strip newlines to prschedule header injection.
     *
     * @param string $str
     *
     * @return string
